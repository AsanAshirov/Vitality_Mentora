// synth.jsx — synthetic data for the BankSandbox. NO real customer data, ever.
...
window.SYNTH = (() => {
  ...
  return { CUSTOMERS, ACCOUNTS, DEPOSITS, TRANSFERS, CARDS, SANCTIONS, PEP, AML_REPORTS, HANDBOOK, ACTIVITY, fmt };
})();
